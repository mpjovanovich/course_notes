...
Convert binary to hex: (10100010)<sub>2</sub>

<details>
    <summary>Convert binary to hex: (10100010)<sub>2</sub></summary>
    <div>
        <ul>
        <li>Break apart: 1010 0010</li>
        <li>(1010)<sub>2</sub> = (10)<sub>10</sub> = (A)<sub>16</sub></li>
        <li>(0010)<sub>2</sub> = (2)<sub>10</sub> = (2)<sub>16</sub></li>
        <li>Concatenate answer: 0xA2</li>
        </ul>
    </div>
</details>
